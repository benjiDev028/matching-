...
<div class="d-flex align-items-center">
    ...
    <section>
        ...
        <div class="d-flex">
         ...
         <span>LOOKING:</span>
            <asp:DropDownList ID="ddlLookingFor" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlLookingFor_SelectedIndexChanged">
        ...
        <span>ANNEE:</span>
            <asp:DropDownList ID="ddlAgeFrom" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlAgeFrom_SelectedIndexChanged">
        ...
        <span>VILLE:</span>
        <asp:DropDownList ID="ddlDistance" runat="server" CssClass="form-control">
            
        </asp:DropDownList>

            <asp:Button ID="btnSearch" runat="server" Text="SEARCH" CssClass="btn btn-danger" BackColor="#CC0000" OnClick="btnSearch_Click" />

        </div>
    </section>
     <asp:Label ID="lblLookInfo" runat="server" Text="Label"></asp:Label>
    ...
    <ItemTemplate>
        <div class="user-card">
          <%--<img src='<%# string.IsNullOrEmpty(Eval("photo").ToString()) ? "default-image-path.jpg" : Eval("photo").ToString() %>' alt="Profile Image" />--%>
            <h5> <%#Eval("prenom")%>  <%# Eval("Nom") %> </h5>
            <p><%# Eval("AnneedeNaissance") %>, <%# Eval("ville") %></p>
            <p><%# Eval("lookingfor") %></p>
            <p><a href='discussion.aspx?refM=<%# Eval("Id") %>'>like </a>   |  <a href='#?refM=<%# Eval("Id") %>'>Chat</a>   |   <a href='viewProfile.aspx?refM=<%# Eval("Id") %>'>View profile</a></p>
